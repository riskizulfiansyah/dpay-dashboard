...
func (h *APIHandler) GetDashboardV1PaymentsSummary(w http.ResponseWriter, r *http.Request, params openapigen.GetDashboardV1PaymentsSummaryParams) {
	h.Payment.GetDashboardV1PaymentsSummary(w, r, params)
}
